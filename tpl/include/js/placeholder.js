...
(this), function(t) {
    ...
    function n(t, e) {
        ...
        e(t);
        else for(r = t ? t.getElementsByTagName("input") : r, n = t ? t.getElementsByTagName("textarea") : n, i = 0, u = r.length + n.length; u > i; i++)
    ...
    var v, b, f, h, p, m, A, y, E, x, T, N, L, w = [
        "text",
        "search",
        "url",
        "tel",
    ...
    if(void 0 === z.placeholder ) {
        for(
            ...
            f = "false" === F.getAttribute(V),
            h = "false" !== F.getAttribute(q),
            m = document.createElement("style"),
            m.type = "text/css",
            A = document.createTextNode("."+k+" { color:"+B+"; }"),
